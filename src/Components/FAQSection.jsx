...
const faqs = [
  {
    question: "How does RegetaInternational ensure the security of its software solutions?",
    answer:
      "We implement advanced security protocols, encryption, and regular audits to safeguard all applications.",
  },
  {
    question: "Can RegetaInternational customize its software solutions to fit our specific needs?",
    answer:
      "Yes, all our solutions are highly customizable to meet your unique business requirements.",
  },
  {
    question: "What industries does RegetaInternational Technologies specialize in serving?",
    answer:
      "We serve industries like healthcare, eCommerce, education, finance, logistics, and more.",
  },
  {
    question: "Can RegetaInternational Technologies accommodate large-scale projects?",
    answer:
      "Absolutely. Our expert team can handle enterprise-level projects with scalability in mind.",
  },
  {
    question: "How does RegetaInternational Technologies ensure the quality of its software solutions?",
    answer:
      "Through rigorous testing, continuous feedback loops, and quality assurance processes.",
  },
  {
    question: "Can RegetaInternational Technologies integrate its software solutions with existing systems?",
    answer:
      "Yes, our solutions are designed for seamless integration with your existing infrastructure.",
  },
  {
    question: "What measures does RegetaInternational Technologies take to protect client data?",
    answer:
      "We use strict data protection policies, secure servers, and comply with GDPR and global data standards.",
  },
  {
    question: "How does RegetaInternational Technologies approach project management?",
    answer:
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 mt-2">
            Find answers to common queries about RegetaInternational Technologies and our services
          </p>
        </div>
